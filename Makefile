...
Dockerfile:
	envsubst '$${BASE_NAMESPACE},$${BASE_IMAGE},$${BASE_TAG},$${CIRCLECI_USER}, \
		...
		$${OAUTHLIB_VERSION},$${TAP_XUNIT_VERSION},$${HADOLINT_VERSION},$${SHELLCHECK_VERSION},$${HELM2_VERSION}, \
		$${HELM3_VERSION},$${TRIVY_VERSION},$${SHFMT_VERSION},$${GOOGLE_SDK_VERSION}$${NODE_VERSION}' \
