...
Dockerfile:
	envsubst '$${BASE_NAMESPACE},$${BASE_IMAGE},$${BASE_TAG},$${CIRCLECI_USER}, \
		$${YAMLLINT_VERSION},$${YQ_VERSION},$${BATS_VERSION},$${JUNIT_MERGE_VERSION},$${FLAKE8_VERSION}, \
		$${OAUTHLIB_VERSION},$${GITPYTHON_VERSION},$${SEMVER_VERSION},$${PYCIRCLECI_VERSION}, \
		$${TAP_XUNIT_VERSION},$${HADOLINT_VERSION},$${SHELLCHECK_VERSION},$${HELM2_VERSION},$${HELM3_VERSION}, \
		$${TRIVY_VERSION},$${SHFMT_VERSION},$${GOOGLE_SDK_VERSION}$${NODE_VERSION}' \
